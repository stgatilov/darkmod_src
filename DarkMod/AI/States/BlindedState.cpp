...
static bool init_version = FileVersionList("$Id: BlindedState.cpp 1435 2007-10-16 16:53:28Z greebo $", init_version);
...
void BlindedState::Init(idAI* owner)
{
	...
	if(owner->AI_AlertNum < owner->thresh_combat - 1)
	{
		owner->Event_SetAlertLevel(owner->thresh_combat - 1);
	}

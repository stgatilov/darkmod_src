...
idCVar cv_pm_swimspeed_variation(	"pm_swimspeed_variation","0.7",			CVAR_GAME | CVAR_ARCHIVE | CVAR_FLOAT, "The swimspeed periodically decreases and increases by this amount.", 0.0f, 1.0f);
idCVar cv_pm_swimspeed_frequency(	"pm_swimspeed_frequency","0.5",			CVAR_GAME | CVAR_ARCHIVE | CVAR_FLOAT, "The swimspeed periodically decreases and increases by this frequency.", 0.0f, 1.0f);

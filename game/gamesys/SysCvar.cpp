...
idCVar cv_pm_mantle_hang_msecs(	"pm_mantle_hang_msecs",		"750",			CVAR_GAME | CVAR_INTEGER | CVAR_ARCHIVE, "Milliseconds of time that player hangs if mantle begins with the player's feet of the ground.", 0, 10000);
idCVar cv_pm_mantle_pull_msecs(	"pm_mantle_pull_msecs",		"500",			CVAR_GAME | CVAR_INTEGER | CVAR_ARCHIVE, "Milliseconds of time it takes for the player to pull themselves up to shoulder level with the mantle surface.", 0, 10000);
idCVar cv_pm_mantle_shift_hands_msecs(	"pm_mantle_shift_hands_msecs",		"0",			CVAR_GAME | CVAR_INTEGER | CVAR_ARCHIVE, "Milliseconds of time it takes for the player to shift their hands from pulling to pushing.", 0, 10000);
idCVar cv_pm_mantle_push_msecs(	"pm_mantle_push_msecs",		"800",			CVAR_GAME | CVAR_INTEGER | CVAR_ARCHIVE, "Milliseconds of time it takes for the player to push themselves up onto the mantle surface.", 0, 10000);
idCVar cv_pm_mantle_pushNonCrouched_msecs("pm_mantle_pushNonCrouched_msecs","550", CVAR_GAME | CVAR_INTEGER | CVAR_ARCHIVE, "Milliseconds of time it takes for the player to push themselves up onto the mantle surface without crouching.",0,100000);
...
idCVar cv_pm_mantle_fastLowObstaces("pm_mantle_fastLowObstacles", "1", CVAR_GAME | CVAR_BOOL | CVAR_ARCHIVE | CVAR_NOCHEAT, "If true, a faster mantle will be performed for low obstacles.", 0, 1);
...
idCVar cv_pm_mantle_fastMediumObstaclesCrouched("pm_mantle_fastMediumObstaclesCrouched", "1", CVAR_GAME | CVAR_BOOL | CVAR_ARCHIVE | CVAR_NOCHEAT, "If true, a faster mantle will be performed for medium-high obstacles in crouched state", 0, 1);
...
idCVar cv_pm_mantle_cancel_speed("pm_mantle_cancel_speed", "150.0", CVAR_GAME | CVAR_FLOAT, "The cancel mantling animation is performed at a certain speed.", 1.0f, 10000.0f);
idCVar cv_pm_mantle_roll_mod("pm_mantle_roll_mod", "1.0", CVAR_GAME | CVAR_FLOAT | CVAR_ARCHIVE | CVAR_NOCHEAT, "The multiplier applied to the roll view angle during a mantle", 0.0f, 1.0f);
idCVar cv_pm_mantle_onlyHangWhenFallingFast("pm_mantle_onlyHangWhenFallingFast", "1", CVAR_GAME | CVAR_BOOL | CVAR_ARCHIVE | CVAR_NOCHEAT, "If true, the hang phase is skipped unless the player is falling fast according to pm_mantle_fallingFast_speedthreshold.", 0, 1);

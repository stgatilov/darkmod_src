...
void main() {
	...
	vec4 c1 = vec4(1.0, 0.0, 0.0, 0.);                                                                  //PARAM c1 = {1.0, 0.0, 0.0, 0.0};
	vec4 c2 = vec4(2.0, 0.0, 0.0, 0.);                                                                  //PARAM c2 = {2.0, 0.0, 0.0, 0.0};
	vec4 c3 = vec4(3.0, 0.0, 0.0, 0.);                                                                  //PARAM c3 = {3.0, 0.0, 0.0, 0.0};
	vec4 c4 = vec4(4.0, 0.0, 0.0, 0.);                                                                  //PARAM c4 = {4.0, 0.0, 0.0, 0.0};
	vec4 c5 = vec4(5.0, 0.0, 0.0, 0.);                                                                  //PARAM c5 = {5.0, 0.0, 0.0, 0.0};
	vec4 c6 = vec4(6.0, 0.0, 0.0, 0.);                                                                  //PARAM c6 = {6.0, 0.0, 0.0, 0.0};
	vec4 c7 = vec4(7.0, 0.0, 0.0, 0.);                                                                  //PARAM c7 = {7.0, 0.0, 0.0, 0.0};
	vec4 c8 = vec4(8.0, 0.0, 0.0, 0.);                                                                  //PARAM c8 = {8.0, 0.0, 0.0, 0.0};
	
	vec4 vec_X1_Y0 = vec4(1.0, 0.0, 0.0, 1.0);                                                          //PARAM vec_X1_Y0 = { 1.0, 0.0 };
	...
	TC = (var_tc1.xxxx) * (vec_X1_Y0);                                                                  //MUL	TC, fragment.texcoord[1].x, vec_X1_Y0;

...
void main() {
	...
	// pixel locations, assuming texture width of 256
	vec4 c0 = vec4(0, 0, 0, 1.0);                                                                       //PARAM c0 = {0, 0, 0, 0};
	vec4 c1 = vec4(0.00390625, 0, 0, 1.0);                                                              //PARAM c1 = {0.00390625, 0, 0, 0};
	vec4 c2 = vec4(0.0078125, 0, 0, 1.0);                                                               //PARAM c2 = {0.0078125, 0, 0, 0};
	vec4 c3 = vec4(0.01171875, 0, 0, 1.0);                                                              //PARAM c3 = {0.01171875, 0, 0, 0};
	vec4 c4 = vec4(0.015625, 0, 0, 1.0);                                                                //PARAM c4 = {0.015625, 0, 0, 0};
	vec4 c5 = vec4(0.01953125, 0, 0, 1.0);                                                              //PARAM c5 = {0.01953125, 0, 0, 0};
	vec4 c6 = vec4(0.0234375, 0, 0, 1.0);                                                               //PARAM c6 = {0.0234375, 0, 0, 0};
	vec4 c7 = vec4(0.02734375, 0, 0, 1.0);                                                              //PARAM c7 = {0.02734375, 0, 0, 0};
	vec4 c8 = vec4(0.03125, 0, 0, 1.0);                                                                 //PARAM c8 = {0.03125, 0, 0, 0};

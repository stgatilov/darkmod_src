...
void main() {
	...
	vec4 c1 = vec4(0.000976563, 0, 0, 1.0);                                                             //PARAM c1 = {0.000976563, 0, 0, 0};
	vec4 c2 = vec4(0.00195313, 0, 0, 1.0);                                                              //PARAM c2 = {0.00195313, 0, 0, 0};
	vec4 c3 = vec4(0.00292969, 0, 0, 1.0);                                                              //PARAM c3 = {0.00292969, 0, 0, 0};
	vec4 c4 = vec4(0.00390625, 0, 0, 1.0);                                                              //PARAM c4 = {0.00390625, 0, 0, 0};
	vec4 c5 = vec4(0.00488281, 0, 0, 1.0);                                                              //PARAM c5 = {0.00488281, 0, 0, 0};
	vec4 c6 = vec4(0.00585938, 0, 0, 1.0);                                                              //PARAM c6 = {0.00585938, 0, 0, 0};
	vec4 c7 = vec4(0.00683594, 0, 0, 1.0);                                                              //PARAM c7 = {0.00683594, 0, 0, 0};
	vec4 c8 = vec4(0.0078125, 0, 0, 1.0);                                                               //PARAM c8 = {0.0078125, 0, 0, 0};

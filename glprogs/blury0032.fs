...
void main() {
	...
	// pixel locations, assuming texture height of 32
	vec4 c0 = vec4(0, 0, 0, 1.0);                                                                       //PARAM c0 = {0, 0, 0, 0};
	vec4 c1 = vec4(0, 0.03125, 0, 1.0);                                                                 //PARAM c1 = {0, 0.03125, 0, 0};
	vec4 c2 = vec4(0, 0.0625, 0, 1.0);                                                                  //PARAM c2 = {0, 0.0625, 0, 0};
	vec4 c3 = vec4(0, 0.09375, 0, 1.0);                                                                 //PARAM c3 = {0, 0.09375, 0, 0};
	vec4 c4 = vec4(0, 0.125, 0, 1.0);                                                                   //PARAM c4 = {0, 0.125, 0, 0};
	vec4 c5 = vec4(0, 0.15625, 0, 1.0);                                                                 //PARAM c5 = {0, 0.15625, 0, 0};
	vec4 c6 = vec4(0, 0.1875, 0, 1.0);                                                                  //PARAM c6 = {0, 0.1875, 0, 0};
	vec4 c7 = vec4(0, 0.21875, 0, 1.0);                                                                 //PARAM c7 = {0, 0.21875, 0, 0};
	vec4 c8 = vec4(0, 0.25, 0, 1.0);                                                                    //PARAM c8 = {0, 0.25, 0, 0};

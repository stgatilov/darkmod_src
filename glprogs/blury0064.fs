...
void main() {
	...
	// pixel locations, assuming texture height of 64
	vec4 c0 = vec4(0, 0, 0, 1.0);                                                                       //PARAM c0 = {0, 0, 0, 0};
	vec4 c1 = vec4(0, 0.015625, 0, 1.0);                                                                //PARAM c1 = {0, 0.015625, 0, 0};
	vec4 c2 = vec4(0, 0.03125, 0, 1.0);                                                                 //PARAM c2 = {0, 0.03125, 0, 0};
	vec4 c3 = vec4(0, 0.046875, 0, 1.0);                                                                //PARAM c3 = {0, 0.046875, 0, 0};
	vec4 c4 = vec4(0, 0.0625, 0, 1.0);                                                                  //PARAM c4 = {0, 0.0625, 0, 0};

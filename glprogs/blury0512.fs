...
void main() {
	...
	// pixel locations, assuming texture height of 512
	vec4 c0 = vec4(0, 0, 0, 1.0);                                                                       //PARAM c0 = {0, 0, 0, 0};
	vec4 c1 = vec4(0, 0.00195313, 0, 1.0);                                                              //PARAM c1 = {0, 0.00195313, 0, 0};
	vec4 c2 = vec4(0, 0.00390625, 0, 1.0);                                                              //PARAM c2 = {0, 0.00390625, 0, 0};
	vec4 c3 = vec4(0, 0.00585938, 0, 1.0);                                                              //PARAM c3 = {0, 0.00585938, 0, 0};
	vec4 c4 = vec4(0, 0.0078125, 0, 1.0);                                                               //PARAM c4 = {0, 0.0078125, 0, 0};
	vec4 c5 = vec4(0, 0.00976563, 0, 1.0);                                                              //PARAM c5 = {0, 0.00976563, 0, 0};
	vec4 c6 = vec4(0, 0.0117188, 0, 1.0);                                                               //PARAM c6 = {0, 0.0117188, 0, 0};
	vec4 c7 = vec4(0, 0.0136719, 0, 1.0);                                                               //PARAM c7 = {0, 0.0136719, 0, 0};
	vec4 c8 = vec4(0, 0.015625, 0, 1.0);                                                                //PARAM c8 = {0, 0.015625, 0, 0};

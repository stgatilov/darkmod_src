...
void main() {
	...
	var_tc7.x = dot(attr_Tangent.xyz, dirFromSky.xyz);                                                  //DP3		result.texcoord[7].x, vertex.attrib[9],	 dirFromSky;
	var_tc7.y = dot(attr_Bitangent.xyz, dirFromSky.xyz);                                                //DP3		result.texcoord[7].y, vertex.attrib[10], dirFromSky;
	var_tc7.z = dot(vec4(attr_Normal, 1).xyz, dirFromSky.xyz);                                          //DP3		result.texcoord[7].z, vertex.attrib[11], dirFromSky;

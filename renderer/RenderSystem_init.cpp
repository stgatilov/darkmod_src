...
idCVarInt r_showLights( "r_showLights", "0", CVAR_RENDERER, "bitmask: 0 = print volumes numbers, highlighting ones covering the view, 1 = draw planes of each volume, 2 = draw edges of each volume" );

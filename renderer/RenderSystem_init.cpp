...
idCVar r_useInteractionTable( "r_useInteractionTable", "2", CVAR_RENDERER | CVAR_INTEGER, "create a full entityDefs * lightDefs table to make finding interactions faster" );

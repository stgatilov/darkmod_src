...
idCVar r_interactionProgram( "r_testARBProgram", "1", CVAR_RENDERER | CVAR_ARCHIVE, "which interaction shader to use: 0 = default / 1 = enhanced" );
...
idCVarBool r_showEntityDraws( "r_showEntityDraws", "0", CVAR_RENDERER, "show effective draw calls per model" );

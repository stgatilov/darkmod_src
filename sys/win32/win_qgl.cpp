...
DEF( GL_VERTEX_PROGRAM_ARB )
DEF( GL_FRAGMENT_PROGRAM_ARB )

DEF( GL_COMBINE_ARB)
DEF( GL_COMBINE_RGB_ARB)
DEF( GL_COMBINE_ALPHA_ARB)
DEF( GL_SOURCE0_RGB_ARB)
DEF( GL_SOURCE1_RGB_ARB)
DEF( GL_SOURCE2_RGB_ARB)
DEF( GL_SOURCE0_ALPHA_ARB)
DEF( GL_SOURCE1_ALPHA_ARB)
DEF( GL_SOURCE2_ALPHA_ARB)
DEF( GL_OPERAND0_RGB_ARB)
DEF( GL_OPERAND1_RGB_ARB)
DEF( GL_OPERAND2_RGB_ARB)
DEF( GL_OPERAND0_ALPHA_ARB)
DEF( GL_OPERAND1_ALPHA_ARB)
DEF( GL_OPERAND2_ALPHA_ARB)
DEF( GL_RGB_SCALE_ARB)
DEF( GL_ADD_SIGNED_ARB)
DEF( GL_INTERPOLATE_ARB)
DEF( GL_SUBTRACT_ARB)
DEF( GL_CONSTANT_ARB)
DEF( GL_PRIMARY_COLOR_ARB)
DEF( GL_PREVIOUS_ARB)
DEF( GL_SRC_COLOR )

DEF( GL_CLAMP_TO_EDGE )
DEF( GL_DEPTH_BOUNDS_TEST_EXT )

...
//#modified-fva; BEGIN
idCVar cst_hudAdjustAspect("cst_hudAdjustAspect", "1", CVAR_GUI | CVAR_BOOL | CVAR_ARCHIVE, "Enable CST anchor system to adjust GUI aspect when the screen aspect ratio isn't 4:3");
//#modified-fva; END
...
void idWindow::Redraw(float x, float y) {
	...
	//if (flags & WIN_DESKTOP) {
		...
		//dc->SetSize(forceAspectWidth, forceAspectHeight); // newly commented out for CST anchored GUIs
	//}
